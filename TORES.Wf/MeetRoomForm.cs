...
namespace TORES.Wf
{
    public partial class MeetRoomForm : Form
    {
        ...
        private void RoomPropLoad() // **Bunu silebilirsin **
        {
        ...
        private void CheckedListBoxLoad()  // **Bunu silebilirsin **
        {
        ...
        private void btnGetir_Click(object sender, EventArgs e) //** btnBring **
        {
            connection.Open();
